...
DuanZi _$DuanZiFromJson(Map<String, dynamic> json) {
  return DuanZi(
      ...
      comments: (json['comments'] as List)
          ?.map((e) => e == null
              ? null
              : DuanZiComments.fromJson(e as Map<String, dynamic>))
          ?.toList());
}

Map<String, dynamic> _$DuanZiToJson(DuanZi instance) => <String, dynamic>{
...
DuanZiComments _$DuanZiCommentsFromJson(Map<String, dynamic> json) {
  return DuanZiComments(
...
Map<String, dynamic> _$DuanZiCommentsToJson(DuanZiComments instance) =>
    <String, dynamic>{
