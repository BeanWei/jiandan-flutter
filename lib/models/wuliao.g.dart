...
WuLiao _$WuLiaoFromJson(Map<String, dynamic> json) {
  return WuLiao(
      ...
      comments: (json['comments'] as List)
          ?.map((e) => e == null
              ? null
              : WuLiaoComments.fromJson(e as Map<String, dynamic>))
          ?.toList());
}

Map<String, dynamic> _$WuLiaoToJson(WuLiao instance) => <String, dynamic>{
...
WuLiaoComments _$WuLiaoCommentsFromJson(Map<String, dynamic> json) {
  return WuLiaoComments(
...
Map<String, dynamic> _$WuLiaoCommentsToJson(WuLiaoComments instance) =>
    <String, dynamic>{
